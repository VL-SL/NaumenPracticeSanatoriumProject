...
const RegistrarDashboard = () => {
  ...
  useEffect(() => {
    const loadUserRegistrations = async () => {
      if (selectedUser && token) {
        try {
          const registrations = await shiftService.getUserRegistrations(
            selectedUser.id,
            token,
          );
  ...
  const handleRegisterUser = async (roomId) => {
    ...
    try {
      ...
      const updatedRegistrations = await shiftService.getUserRegistrations(
        selectedUser.id,
        token,
      );
  ...
  const handleShowAvailableRooms = async () => {
    try {
      const rooms = await shiftService.getAvailableRooms(
        selectedShift.id,
        token,
      );
  ...
  const isRegisteredForSelectedShift =
    selectedShift &&
          ...
          <div className="registrar-content">
                    ...
                    >
                      ...
                      <div className="user-info">
                        ...
                        <p className="user-details">
                          Тел.: {user.phone || "не указан"} | Email:{" "}
                          {user.email}
                        </p>
                      </div>
                    </div>
            ...
            <div className="user-details-section">
              <div className="user-details-header">
                <h2
                  className={`user-details-title ${isEditing ? "editing" : ""}`}
                >
                  {isEditing
                    ? "Редактирование пользователя"
                    : selectedUser
                      ...
                      <div className="shift-details">
                        ...
                        {isRegisteredForSelectedShift ? (
                          <div className="registration-info">
                            <p>
                              Статус: <strong>Зарегистрирован</strong>
                            </p>
                          ...
                          <div className="registration-info">
                            <p>
                              Статус: <strong>Не зарегистрирован</strong>
                            </p>
                            <div className="registration-actions">
                              <button
